...
VALUES
   ("P1","U001","Hoje e dia de role com o dog!", 5, 2),
   ("P2","U002","A vida reflete aquilo que você sente. Sinta gratidão!", 2, 5),
   ("P3","U003","Não tenha pressa. Amanhã será um novo recomeço!", 3,1),
   ("P4","U004"," Vamos happy hour!", 10,1);
